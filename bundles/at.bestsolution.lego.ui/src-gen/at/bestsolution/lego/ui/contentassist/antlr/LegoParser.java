		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFxmlIncludeAccess().getGroup_8(), "rule__FxmlInclude__Group_8__0");
					...
					put(grammarAccess.getFxmlIncludeAccess().getSource2dAssignment_3(), "rule__FxmlInclude__Source2dAssignment_3");
					put(grammarAccess.getFxmlIncludeAccess().getSource3dAssignment_7(), "rule__FxmlInclude__Source3dAssignment_7");
					put(grammarAccess.getFxmlIncludeAccess().getOriginXAssignment_8_1(), "rule__FxmlInclude__OriginXAssignment_8_1");
					put(grammarAccess.getFxmlIncludeAccess().getOriginYAssignment_8_2(), "rule__FxmlInclude__OriginYAssignment_8_2");
					put(grammarAccess.getFxmlIncludeAccess().getOriginZAssignment_8_3(), "rule__FxmlInclude__OriginZAssignment_8_3");
