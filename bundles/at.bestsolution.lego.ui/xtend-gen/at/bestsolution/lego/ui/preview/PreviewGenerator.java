...
public class PreviewGenerator {
  ...
  public CharSequence generatePreview(final Model model) {
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t");
    CharSequence _generatePreview = this.lego2.generatePreview(model);
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t");
    CharSequence _generatePreview_1 = this.lego3d.generatePreview(model);
    _builder.append(_generatePreview_1, "\t\t\t\t");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t\t");
    _builder.append("</ScrollPane>");
    _builder.newLine();
